        ...
        <aside :class="[
            ...
            <div class="flex h-16 items-center gap-3 px-5 border-b border-white/[0.06] shrink-0">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[11px] text-white/40 uppercase tracking-widest">My Account</p>
                </div>
                <button class="ml-auto lg:hidden p-1 rounded-md text-white/40 hover:text-white" @click="sidebarOpen = false"><XMarkIcon class="h-4 w-4" /></button>
            </div>
            <p class="mt-5 mb-1 px-5 text-[10px] font-semibold uppercase tracking-[0.12em] text-white/30">Menu</p>
            ...
            <div class="border-t border-white/[0.06] p-3 shrink-0">
                <div class="flex items-center gap-3 rounded-lg px-2 py-2 hover:bg-white/[0.06] transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-[11px] text-white/40 truncate">Customer</p>
                    </div>
                    <Link :href="route('logout')" method="post" as="button" class="p-1.5 rounded-md text-white/30 hover:text-red-400 transition-colors"><ArrowRightOnRectangleIcon class="h-4 w-4" /></Link>
                </div>
            </div>
        </aside>
        <div class="flex flex-1 flex-col overflow-hidden min-w-0">
            <header class="flex h-14 items-center justify-between gap-4 border-b border-gray-200/60 bg-white/90 backdrop-blur-sm px-4 lg:px-6 shrink-0">
                <div class="flex items-center gap-3">
                    <button class="lg:hidden rounded-lg p-2 text-gray-500 hover:bg-gray-100" @click="sidebarOpen = true"><Bars3Icon class="h-5 w-5" /></button>
                    <div class="flex items-center gap-1.5 text-sm">
                        <span class="text-gray-400 hidden sm:inline">Portal</span>
